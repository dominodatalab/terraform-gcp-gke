...
output "cluster" {
  value = {
    ...
    "cluster_ca_certificate": google_container_cluster.domino_cluster.master_auth[0].client_ca_certificate,
    ...
    "public_endpoint": google_container_cluster.domino_cluster.private_cluster_config.public_endpoint
  }
}
